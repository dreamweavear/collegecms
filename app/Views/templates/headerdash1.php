...
<head>
   ...
   <style>
            body {
                ...
                line-height: 1.6; /* हिंदी टेक्स्ट के लिए लाइन हाइट जरूर बढ़ाएं */
            }

            /* अंग्रेज़ी टेक्स्ट के लिए विशेष क्लास */
            .english-text {
                font-family: 'Roboto', sans-serif;
            }

            /* या फिर ऑटोमैटिक भाषा डिटेक्शन */
            :lang(hi) {
...
<body>
  ...
  <ul class="dropdown-menu shadow-lg" aria-labelledby="navbarDropdown" style="border: none; min-width: 250px;">
    ...
    <!-- डिवाइडर -->
            ...
            <li><a class="dropdown-item py-2" href="#">
              <i class="bi bi-people text-secondary me-2"></i> Alumni  </a>
           </li>
    </ul>
    </li>     
...
<!-- GAllery  -->
                    <li class="nav-item mx-1">
                <a class="nav-link text-white d-flex align-items-center py-2 px-3 rounded" href="<?= site_url('gallery') ?>">
