                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card h-100 card-hover">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-subtitle mb-2 text-muted">Director</p>
                                <p class="card-text">PhD in Computer Science from IIT Delhi with 25+ years of academic experience</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card h-100 card-hover">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Dr. Priya Patel</h5>
                                <p class="card-subtitle mb-2 text-muted">Dean Academics</p>
                                <p class="card-text">Expert in Artificial Intelligence and Machine Learning with industry experience</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card h-100 card-hover">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Specialized in Cybersecurity and Network Systems with research publications</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12">
                <div class="card bg-light border-0">
                    <div class="card-body p-5 text-center">
                        ...
                        <p class="lead">At TechVision, we believe in nurturing not just skilled professionals but well-rounded individuals who can lead the technological revolution with integrity and innovation. Our holistic approach combines rigorous academics, hands-on training, industry exposure, and value-based education to create the tech leaders of tomorrow.</p>
                        <a href="#" class="btn btn-primary btn-lg mt-3">Explore Our Programs</a>
                    </div>
                </div>
            </div>
        </div>
